package net.mcreator.thejonkler;
...
@Mod("the_jonkler")
public class TheJonklerMod {
	public static final Logger LOGGER = LogManager.getLogger(TheJonklerMod.class);
	public static final String MODID = "the_jonkler";

	public TheJonklerMod() {
