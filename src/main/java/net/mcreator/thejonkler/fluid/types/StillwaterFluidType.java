...
package net.mcreator.thejonkler.fluid.types;
...
public class StillwaterFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("the_jonkler:block/still_water"), FLOWING_TEXTURE = new ResourceLocation("the_jonkler:block/still_water");
